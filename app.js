(() => {
  ...
  async function startMix() {
    ...
    const step = () => {
      ...
      // User-requested linear 4-second fade: current deck 100→0,
      // incoming deck 0→100, with no volume dip/gap between the two decks.
      const oldGain = (1 - p) * master;
      const newGain = p * master;
